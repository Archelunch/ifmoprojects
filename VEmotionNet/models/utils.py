...
from pytorch.VEmotionNet.models.VGG_Face_torch import VGG_Face_torch
...
def Initial(model):
    ...
    model_emotion.load_state_dict(torch.load('/media/stc_ml_school/team1/pytorch/VEmotionNet/models/best7164.model'))
