...
def train():
    ...
    audio_processor = LibrosaAudioProcessor(type=params['preproc']['audio']['type'],
...
def jfhfjtest():
    ...
    test_audio_processor = LibrosaAudioProcessor(type=train_params['preproc']['audio']['type'],
    ...
    batch_processor = SimpleBatchProcessor(use_pin_memory=train_params['batch_proc']['use_pin_memory'],
